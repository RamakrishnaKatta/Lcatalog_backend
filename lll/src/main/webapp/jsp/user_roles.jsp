                      ...
                      <div class="box-body">
                         ...
                         <div class="row">
                          ...
                          <div class="form-group">
                              <h5 class="box-title">*Add Society User Role Id : </h5>
                              <input type="text" class="form-control" id="role_id" required data-msg="Please Enter Role Id">
                            </div>
                            </div>
                          <div class="col-md-6">
                          <div class="form-group">
                              <h5 class="box-title">*Add Society User Role Name : </h5>
...
<script type="text/javascript"
  src="<c:url value="/resources/js/users_roles.js" />"></script>