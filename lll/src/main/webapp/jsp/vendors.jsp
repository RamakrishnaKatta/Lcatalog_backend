				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<b class="headerText">Add Vendor</b>
						</h4>
					</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<b class="headerText">Edit Vendor</b>
						</h4>
					</div>
					<div class="modal-body">
						<form role="form" id="data" method="post"
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="name">Id :</label> <input type="text"
												class="form-control rdStrict" name="id" id="id_e">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="name">Name :</label> <input type="text"
												class="form-control rd" name="name" id="name_e">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="name">Type :</label> <input type="text"
												class="form-control rd" name="type" id="type_e">
										</div>
									</div>
								</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="name">Code :</label> <input type="text"
												class="form-control rd" name="code" id="code_e">
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<button type="button" class="btn btn-sm btn-info save">Save</button>
								</div>
							</div>
			...
			<div class="col-md-12">
				<div class="box box-info main_box">
					...
					<div class=" tableSection sectionBgWhite">
						...
						<table id="myTable"
							class="stripe table table-bordered table-striped"></table>
					</div>
